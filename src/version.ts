...
import { getAndroidPlatform, getIosPlatform } from './platforms';
import { Context, ManifestMeta, VersionCalculator } from './types';
 ...
 */
export const calculateAndroidVersion: VersionCalculator = (
	meta,
	config,
	context
) => {
 ...
 */
export const calculateIosVersion: VersionCalculator = (
	meta,
	config,
	context
) => {
